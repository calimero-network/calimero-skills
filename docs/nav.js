/* AI Agent Skills Docs — Shared Navigation + Full-text Search */
(function () {
  'use strict';

  const REPO = 'https://github.com/calimero-network/calimero-skills';
  const PAGES_BASE = './';
    ...
    sb.innerHTML = `
      <div class="sidebar-logo">
        <div class="sidebar-logo-inner">
          ...
          <div class="sidebar-logo-text">
            <strong>Calimero <em>Skills</em></strong>
      ...
      <div class="sidebar-footer">
        ...
        <div class="sidebar-footer-links">
          <a href="https://github.com/calimero-network/calimero-skills" target="_blank" rel="noopener">
    ...
    return index
      .map((page) => {
        ...
        return {
          ...page,
          excerpt,
          score: (titleMatch ? 2 : 0) + (headingMatch ? 1 : 0) + (excerpt ? 0.5 : 0),
        };
      })
      .filter(Boolean)
  ...
  function renderResults(results, query) {
    ...
    if (!results.length) {
      el.innerHTML =
        '<p class="search-hint">No results for <strong>"' + escapeHtml(query) + '"</strong></p>';
      selectedIdx = -1;
      return;
    }
  ...
  function closeSearch() {
    ...
    if (overlay) {
      ...
      if (results)
        results.innerHTML = '<p class="search-hint">Type to search across all documentation…</p>';
    }
  }
